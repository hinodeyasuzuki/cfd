/*
 有限体積法による室内温熱環境分析 20151219 cfd2015i.pyから作成
　画面IO機能

 
copyright(C) 2015-2017  Hinodeya Insititute for Ecolife co.ltd.
					有限会社ひのでやエコライフ研究所
...
1.6 パラメータ入力方法の変更　meshtypeが読み込めない 160509 
*/
...
//ワーカーを使って、計算を完全に別に行う：メイン側で描画・操作のみ
...
// ワーカーの実装チェック
if (window.Worker) {  
	var worker = new Worker("./load2.php?p=" + r2 );
