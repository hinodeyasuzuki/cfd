...
<head>
	<meta charset="UTF-8">
	<title>室内空気の流れ計算（エアコン、送風、断熱の効果）比較</title>
	...
	<link href="./cfd_2g.css" rel="stylesheet" type="text/css" />
</head>

<body>
<div class="header">
	<h1>室内空気の流れ計算　並列比較</h1>
...
<div class="field field2">
	<div id="graphs"><!-- display wall graphs -->
		<!-- wall left side with window -->
		<div class="wall_base">
			<canvas class="setting" id="G2_layout0" width="400" height="400"></canvas>
			<canvas class="vresult base" id="G2_graph0base" width="400" height="400"></canvas>
			<canvas class="vresult move left" id="G2_graph0" width="400" height="400"></canvas>
		</div>

		<!-- front view of wall, code is top -->
		<div class="front_base">
			<canvas class="setting" id="G2_layout2" width="400" height="400"></canvas>
			<canvas class="vresult base" id="G2_graph2base" width="400" height="400"></canvas>
			<canvas class="vresult move front" id="G2_graph2" width="400" height="400"></canvas>
		</div>

		<!-- floor -->
		<div class="floor_base">
			<canvas class="setting" id="G2_layout1" width="400" height="400"></canvas>
			<canvas class="vresult base" id="G2_graph1base" width="400" height="400"></canvas>
			<canvas class="vresult move floor" id="G2_graph1" width="400" height="400"></canvas>
		</div>
	</div>
	...
	<table border=0 style="position:absolute;top:0px;">
		<tr>
			<td>
			<canvas id="G2_legend" width="600" height="40" style="position:relative"></canvas>
			<table border=0><tr>
				<td width="120px">10℃←</td>
				<td width="100px">15℃</td>
				<td width="80px" align="right">→25℃</td>
...
<div class="controls">
	<div class="control">
		...
		<div class="tabcontents" id="tab2c" style="display:none;">
			...
			<tr>
				<th>屋外気温（℃）</th><td><input type="text" id="G2_InletPhi" value="5"></td>
			</tr>
			<tr>
				<th>室内気温（℃）</th><td><input type="text" id="G2_InsidePhi" value="17"></td>
			</tr>
			<tr>
				<th>床面温度（℃）</th><td><input type="text" id="G2_FloorPhi" value="17"></td>
			</tr>

			<tr>
				<th>障害物温度（℃）</th><td><input type="text" id="G2_ObsPhi" value="17"></td>
			</tr>

			<tr>
				<th>窓の断熱性能</th><td>
					<select id="G2_windowKset">
						<option value="6">アルミ枠単板ガラス</option>
						<option value="3">アルミ枠複層ガラス</option>
						<option value="2">樹脂枠複層ガラス</option>
						<option value="1.5">樹脂枠Low-e複層ガラス</option>
			...
			<tr>
				<th>エアコン風速(m/s)</th><td><input type="text" id="G2_ACwind" value="2"></td>
			</tr>
			<tr>
				<th>サーキュレータ風速(m/s)</th><td><input type="text" id="G2_CirculatorWind" value="0"></td>
			</tr>
			<tr>
				<th>最大計算時間（分）</th><td><input type="text" id="G2_maxtime_minute" value="10"></td>
			</tr>
			<tr>
				<td colspan=2></td>
			</tr>
		...
		<div class="tabcontents" id="tab3c" style="display:none">
			...
			<td>
				<div id="G2_step">設定した条件で、計算を実行します。</div>
			</td>
			</tr>
			</table>
		</div>
	...
	<div class="detail_matrix">
		<p style="clear:both;"></p>
		<h2>計算結果の数値表  <input type="button" value="表示/非表示" onclick="$('#G2_res').toggle();"></h2>
		<textarea id="G2_res" style="display:none"  rows=20 cols=80></textarea>
	</div><!--// detail_matrix -->

</div>


<div style="clear:both;margin:10px;padding:10px;background-color:#fff;">
	<h3>表示フィールドの概要</h3>
